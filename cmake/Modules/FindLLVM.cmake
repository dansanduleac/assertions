################################################################
# Largely copied from:
# https://github.com/cloudera/impala/blob/master/CMakeLists.txt
################################################################
...
# LLVM_CXXFLAGS - llvm full CXX flags (also contain includes, -g/-O? stuff,
#                 should be trimmed)
...
exec_program(${LLVM_CONFIG_EXECUTABLE}
  ARGS --src-root
...
set (DESIRED_LIBS bitreader core irreader)
execute_process(
  COMMAND ${LLVM_CONFIG_EXECUTABLE} --libnames ${DESIRED_LIBS}
...
message(STATUS "LLVM CXX compile flags: ${LLVM_CXXFLAGS}")
